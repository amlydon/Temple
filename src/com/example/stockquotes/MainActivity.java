...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		stockSymbol = (EditText) findViewById(R.id.etxtInput);
		CompanyName = (EditText) findViewById(R.id.etxtCompany);
		price = (EditText) findViewById(R.id.etxtStockPrice);
	...
	public void onClick(View arg0) {
		...
		case R.id.btnSearch:
			...
			String URL = "http://finance.yahoo.com/webservice/v1/symbols/"
					+ strSymbol + "/quote?format=json";

			if (strSymbol == "") {
				alertDialog("Enter a company");
			} else {
				// If strSymbol is not empty make request with URL
	...
	private class RetrieveMessages extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				CompanyName.setText("Company name: " + ComName);
